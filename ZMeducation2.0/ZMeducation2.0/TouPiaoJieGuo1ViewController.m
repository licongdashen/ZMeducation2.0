//
//  TouPiaoJieGuo1ViewController.m
//  ZMeducation2.0
//
//  Created by 李聪 on 2017/7/31.
//  Copyright © 2017年 licong. All rights reserved.
//

#import "TouPiaoJieGuo1ViewController.h"

@interface TouPiaoJieGuo1ViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation TouPiaoJieGuo1ViewController
...
- (void)viewDidLoad {
    ...
    [RequestOperationManager getParametersDic:dic success:^(NSMutableDictionary *result) {
        ...
        self.M2043Arr = result[@"options"][0][@"contents"];
        [self.tabv1 reloadData];
        
        for (NSMutableDictionary *dic in self.M2043Arr) {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    labe2.frame = CGRectMake(0, 30,((float)[self.M2043Arr[indexPath.row][@"voteCount"] intValue]/self.count)*800, 30);
    labe2.text = [NSString stringWithFormat:@"%g%%",((float)[self.M2043Arr[indexPath.row][@"voteCount"] intValue])/self.count*100];
