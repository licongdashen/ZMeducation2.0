 ...
 *字体
 */
#define DEF_MyFont(x)     [UIFont fontWithName:@"HelveticaNeue-Light" size:x]
...
[clearButton setImage:[UIImage imageNamed:@"delete_icon"] forState:UIControlStateHighlighted];
