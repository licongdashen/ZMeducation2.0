...
-(void)setDic:(NSDictionary *)dic
{
    ...
    self.label1 = [[UITextView alloc]initWithFrame:CGRectMake(35, 150, 700, 200)];
    self.label1.backgroundColor = [UIColor clearColor];
    self.label1.font = DEF_MyFont(16);
    self.label1.editable = NO;
    [self.view addSubview:self.label1];
    
    self.label2 = [[UITextView alloc]initWithFrame:CGRectMake(35, self.label1.bottom + 20, 700, 200)];
    self.label2.backgroundColor = [UIColor clearColor];
    self.label2.font = DEF_MyFont(16);
